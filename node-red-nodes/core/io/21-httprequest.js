...
var x = {
    "id": "dcdef70a.a31ba", "z": "d419dec8.700c28", "type": "real-time-data", "_def":
    {
        "category": "input", "color": "#a6bbcf", "defaults":
        {
            "name": { "value": "" }, "triggerMode": { "value": "none" }, "delaySecond": { "value": 1 }, "intervalSecond": { "value": 1 },
            "apiUrl": { "value": "", "required": true }, "apiChoice": { "value": "1" }, "returnType": { "value": "json" },
            "enableButton": { "value": true }
        },
        "inputs": 0, "outputs": 1, "icon": "./icons/input-real-time-data.png", "button": {},
        "type": "real-time-data", "set": {
            "id": "node-red/input-real-time-data", "name": "input-real-time-data",
            "types": ["real-time-data"], "enabled": true, "local": false, "module": "node-red", "version": "0.17.4", "added": true
        }
    },
    "inputs": 0,
    "outputs": 1,
    "name": "",
    "triggerMode": "none", "delaySecond": 1, "intervalSecond": 1, "apiUrl": "12345", "apiChoice": "1", "returnType": "json", "enableButton": true, "changed": false, "moved": false, "w": 160, "h": 30, "x": 140, "y": 319, "ports": [0], "dirty": false, "valid": true, "selected": true, "_ports": [[{ "__data__": 0 }]], "resize": false
}